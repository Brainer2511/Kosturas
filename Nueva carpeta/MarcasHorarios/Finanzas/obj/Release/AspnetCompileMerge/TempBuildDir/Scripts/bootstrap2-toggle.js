 ...
 +function ($) {
	...
	Toggle.prototype.render = function () {
		...
		var size = this.options.size === 'large' ? 'btn-large'
			...
			: ''
        var $toggleOn = $('<label class="btn-toggle">').html(this.options.on)
			.addClass(this._onstyle + ' ' + size)
        var $toggleOff = $('<label class="btn-toggle">').html(this.options.off)
			.addClass(this._offstyle + ' ' + size + ' active')
        var $toggleHandle = $('<span class="toggle-handle btn-toggle btn-default">')
			.addClass(size)
		var $toggleGroup = $('<div class="toggle-group">')
			.append($toggleOn, $toggleOff, $toggleHandle)
        var $toggle = $('<div class="toggle btn-toggle" data-toggle="toggle">')
