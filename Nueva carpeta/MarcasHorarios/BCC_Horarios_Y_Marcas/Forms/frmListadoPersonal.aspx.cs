...
namespace BCC_Horarios_Y_Marcas.Forms
{
    public partial class frmListadoPersonal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var persona = Session["DatosUsuario"];
            var seccion = ((Usuario)persona).NomSeccion;
            var depto = ((Usuario)persona).NomDepartamento;

            if (seccion.Equals("Supervisor"))
            {
        ...
        protected void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            DataTable datos = servicio.ConsultarPersonal(codigoDpto, codigoSeccion);
