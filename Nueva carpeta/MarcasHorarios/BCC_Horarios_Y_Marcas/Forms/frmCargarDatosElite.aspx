<%@ Page Title="Cargar Datos CMS Elite" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmCargarDatosElite.aspx.cs" Inherits="BCC_Horarios_Y_Marcas.Forms.frmCargarDatosElite" %>
        ...
        <table style="width: 50%; margin: 0 auto">
            <tr>
                <td style="text-align: center">
                    <asp:Button ID="btnProcesar" runat="server" CssClass="btn btn-default " Text="Procesar" OnClick="btnCargarElite_Click" Visible="true" AutoPostBack="true" />
                </td>
            </tr>
        </table>
    </div>
